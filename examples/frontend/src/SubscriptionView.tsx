...
const FeedsToSubscribe: React.FC<{ suiAddress: string }> = ({ suiAddress }) => {
  ...
  async function getFeed() {
    ...
    const service_fields = (service.object.json as Record<string, any>) || {};
    ...
    const clock_fields = (clock.object.json as Record<string, any>) || {};
    const current_ms = clock_fields.timestamp_ms;
