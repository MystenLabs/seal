...
- The first parameter must be the requested identity, excluding the package ID prefix. For example: `id: vector<u8>`. See more security best practices at [Choosing key ids and nonces](/SecurityBestPractices#choosing-key-ids-and-nonces).
