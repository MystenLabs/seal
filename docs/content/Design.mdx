...
=======
Time-lock encryption can be applied to a variety of on-chain use cases, including MEV-resistant trading, secure voting, and more. For additional examples and useful implementation patterns, see [Example patterns](ExamplePatterns.md).
