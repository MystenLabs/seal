...
To understand how to use these key servers in Seal SDK, see [Using Seal](/UsingSeal). To understand the differences of server types and use cases, see [Seal Server Overview](/ServerOverview).
