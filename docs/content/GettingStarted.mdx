...
- Use [verified key servers](/docs/Pricing#verified-key-servers) for Testnet.
...
See [Example patterns](/docs/ExamplePatterns) to help you get started.
...
- Read the [Seal Design](/docs/Design) documentation for a deeper understanding of how Seal works.
- Explore example apps in the [Examples Directory](https://github.com/MystenLabs/seal/tree/main/examples).
- Review the [Security Best Practices](/docs/SecurityBestPractices) to ensure you're following recommended guidelines.
